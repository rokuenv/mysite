...
<html lang="ru">
	...
	<meta name="enot" content="4561675700976s2fUQND3VLx67OSZQa9SInslPGxQ74Nm">
      	<meta name="viewport" content="width=device-width, initial-scale=1">
        <meta name="enot" content="02e07d60" />
      	<title>Zero-Grief | Главная</title>
      	<link rel="stylesheet" href="css/bootstrap.css">
      	<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.3.1/css/all.css" integrity="sha384-mzrmE5qonljUremFsqc01SB46JvROS7bZs3IO2EmfFsd15uHvIt+Y8vEf7N7fWAU" crossorigin="anonymous">
      	<link rel="stylesheet" href="css/style.css">
	</head>
  <body>
  		<div style="position:relative; left:200px;">Play.Zero-Grief.Ru</div>
	      <div class="container">
         	<div class="row">
	    ...
	    <footer>
			<div class="container">
		        <span>© 2023 Zero-Grief - Все права защищены.</span>
